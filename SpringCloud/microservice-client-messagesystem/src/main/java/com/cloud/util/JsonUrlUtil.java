...
//   }
           ...
           Class<D2> detailClass2)
   {
       ...
       T mainEntity = JsonUrlUtil.toBean(jsonObject, mainClass);
       List<D1> detailList1 = JsonUrlUtil.toList(jsonArray1, detailClass1);
       List<D2> detailList2 = JsonUrlUtil.toList(jsonArray2, detailClass2);
           ...
           Class<D3> detailClass3)
   {
       ...
       List<D1> detailList1 = JsonUrlUtil.toList(jsonArray1, detailClass1);
       List<D2> detailList2 = JsonUrlUtil.toList(jsonArray2, detailClass2);
       List<D3> detailList3 = JsonUrlUtil.toList(jsonArray3, detailClass3);
