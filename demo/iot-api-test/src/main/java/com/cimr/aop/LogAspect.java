...
import com.cimr.boot.redis.RedisUtil;
...
public class LogAspect {
	...
	private ApiAccessLogService apiAccessLogService;
	 ...
	 @Pointcut("execution(public * com.cimr.api.schedule.task.*.*(..))")  
	    public void webLog(){}  
...
//	    }  
	    ...
	    public Object arround(ProceedingJoinPoint pjp) {  
	    	...
	    	redisUtil.incr("iotTEST:accessNum", 1);
	    	Object c = null;
	        ...
	        try {  
	        	...
	        	c = pjp.proceed();  
	            log.setRes(true);
	            redisUtil.incr("iotTEST:success", 1);
	        } catch (Throwable e) {  
		        ...
		        logs.error(GsonUtil.objToJson(log));
		        redisUtil.incr("iotTEST:faild", 1);
	        }  
