package com.cimr.master.sysmanage.dto;
...
public class FileDto
{
  ...
  public FileDto(JSONObject jsonObject)
  {
    ...
    this.minLogoUrl = jsonObject.get("minLogoUrl")==null || "null".equals(jsonObject.get("minLogoUrl").toString()) ? null : jsonObject.get("minLogoUrl").toString();
    this.middleLogoUrl = jsonObject.get("middleLogoUrl")==null ||"null".equals(jsonObject.get("middleLogoUrl").toString()) ? null : jsonObject.get("middleLogoUrl").toString();
    this.maxLogoUrl = jsonObject.get("maxLogoUrl")==null ||"null".equals(jsonObject.get("maxLogoUrl").toString()) ? null : jsonObject.get("maxLogoUrl").toString();
//    this.imgHeight = ((Integer)jsonObject.get("imgHeight"));
//    this.imgWidth = ((Integer)jsonObject.get("imgWidth"));
    this.type = jsonObject.get("type")==null ||"null".equals(jsonObject.get("type").toString()) ? "" : jsonObject.get("type").toString();
    this.descript = jsonObject.get("descript")==null ||"null".equals(jsonObject.get("descript").toString()) ? "" : jsonObject.get("descript").toString();
  }
