...
//				String ext = "."+sysFile.getExt();
                ...
                LogUtil.printStackTraceToLog(req,new RuntimeException("从分布式文件系统下载文件出错了.."), logger, SysEnums.HTTP_500,null);
...
// .updateDownloadNum(id);
            ...
            LogUtil.printStackTraceToLog(req,e, logger, SysEnums.HTTP_500,null);
