...
public class AreaAjaxController {
	...
	@RequestMapping({ "save" })
	@ResponseBody
	public HttpResult save(Area area, HttpSession session) {
	...
	@ResponseBody
	public HttpResult delete(String areaId) {
	...
	@ResponseBody
	public HttpResult edit(@RequestParam(required = true) String areaId) {
	...
	public HttpResult getSelectData(@RequestParam("pid") String pid, String provinceId, String cityId, String areaId) {
