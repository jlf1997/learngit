...
public class AppProperties {
	...
	private static String platformName = "基础开发平台";
	
	
	private static String title = "基础开发平台";
	 ...
	 * 主页地址
	 */
	private static String mainIndexPage="/index/nav/index";
	 ...
	 * 首页地址
	 */
	private static String homePage = "comm/index/home";
	
	
	private static String defaultPage = "comm/login/login";
	...
	@Value("${app.config.homePage}")
	public static void setHomePage(String homePage) {
		AppProperties.homePage = homePage;
	}

	public static String getDefaultPage() {
		return defaultPage;
	}
	@Value("${app.config.defaultPage}")
	public static void setDefaultPage(String defaultPage) {
		AppProperties.defaultPage = defaultPage;
	}

	public static String getPlatformName() {
		return platformName;
	}
	@Value("${app.config.platformName}")
	public static void setPlatformName(String platformName) {
		AppProperties.platformName = platformName;
	}
