...
public class HistoryRealDataController {
	...
	public HttpResult findTersAllRealData(
	...
	public HttpResult findTersRealDataIncludeFields(
			@PathVariable("singal") String singal,
			@PathVariable(value="terid",required=true) String terid,
			@RequestParam(name="beg",required=false) Long beg,
			@RequestParam(name="end",required=false) Long end,
	...
	public HttpResult findTersRealDataExcludeFields(
			@PathVariable("singal") String singal,
			@PathVariable(value="terid",required=true) String terid,
			@RequestParam(name="beg",required=false) Long beg,
			@RequestParam(name="end",required=false) Long end,
	...
	public HttpResult findTersAllRealDataBooleanCount(
			@PathVariable("singal") String singal,
			@PathVariable(value="terid",required=true) String terid,
			@RequestParam(name="beg",required=false) Long beg,
			@RequestParam(name="end",required=false) Long end,
