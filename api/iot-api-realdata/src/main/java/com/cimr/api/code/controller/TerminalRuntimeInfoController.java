...
public class TerminalRuntimeInfoController {
	...
	public HttpResult getAllDataBoolean(
		...
		List<Map<String,Object>> res =  terminalRuntimeInfoService.getDataBoolean(termimals,includeType,fields,countIncludeType,countFields);
	...
	public HttpResult getData(
		...
		List<Map<String,Object>> res = terminalRuntimeInfoService.getData(termimals,includeType,fields);
		HttpResult httpResult = new HttpResult(true,"");
		httpResult.setData(res);
		return httpResult;
