...
public class TerminalLastData {
	...
	@Deprecated
	public HttpResult getDateInclude(
			@RequestParam("fields") String[] fields,
			@PathVariable("signal") String signal,
			@RequestBody List<TerimalModel> termimals,
			@PathVariable("projectId") String projectId
			) {
		List<Map<String,Object>> res =  realTimeDateService.getAllDateInclude(termimals,signal,projectId,fields);
	...
	@Deprecated
	public HttpResult getDateExclude(
			@RequestParam("fields") String[] fields,
			@PathVariable("signal") String signal,
			@RequestBody List<TerimalModel> termimals,
			@PathVariable("projectId") String projectId
		...
		List<Map<String,Object>> res = realTimeDateService.getAllDateExclude(termimals,signal,projectId,fields);
		HttpResult httpResult = new HttpResult(true,"");
		httpResult.setData(res);
		return httpResult;
	}
	...
	@Deprecated
	public HttpResult getAllDate(
			@PathVariable("signal") String signal,
			@RequestBody List<TerimalModel> termimals,
			@PathVariable("projectId") String projectId
			) {
	
		List<Map<String,Object>> res = realTimeDateService.getAllDate(termimals,signal,projectId);
		HttpResult httpResult = new HttpResult(true,"");
		httpResult.setData(res);
		return httpResult;
	}
	...
	public HttpResult getAllDateBoolean(
			@PathVariable("signal") String signal,
			@RequestBody List<TerimalModel> termimals,
			@RequestParam(name="includeType",required=false) String includeType,
			@RequestParam(name="fields",required=false) String[] fields,
